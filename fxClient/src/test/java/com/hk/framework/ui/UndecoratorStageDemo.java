/**
 * Demo purpose In-SideFX (Un)decorator for JavaFX primaryStage License: You can use
...
public class UndecoratorStageDemo extends Application {
    ...
    public void start(final Stage stage) throws Exception {
        ...
        Region root = null;
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/hk/framework/ui/ClientArea.fxml"));
  ...
  /*
        ...
        // Transparent scene and primaryStage
